...
<head>
	...
	background-color: #363636;
		...
		#yxbox .pos0{
			background:url('static/img/sankbox/bg_tree.png') no-repeat;
		}
		#yxbox .pos1{
			background:url('static/img/sankbox/wall.jpg') no-repeat;
		}
		#yxbox .pos2{
			background:url('static/img/sankbox/allow_bg.jpg') no-repeat;
		}
		#yxbox .pos3{
			background:url('static/img/sankbox/target.jpg') no-repeat;
		}
		#yxbox .person1,#yxbox .person2,#yxbox .person3,#yxbox .person4{
			width:50px;
			height:50px;
			position:absolute;
			background-image:url('static/img/sankbox/person.png');
		...
		#yxbox .box{
			...
			height:50px;
			position:absolute;
			background-image:url('static/img/sankbox/box.jpg');
			background-repeat: no-repeat;
		}
		#yxbox .person1{
	...
	<script>
		BoxYouXi = {
			...
			createMap:function(gk){
				document.title = 'The current '+(this.num+1)+' level';
			...
			impactCheck:function(obj1,obj2){//��ײ���
